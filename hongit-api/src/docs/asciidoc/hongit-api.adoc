...
include::{snippets}/article/getAllByBoardId/path-parameters.adoc[]
...
include::{snippets}/article/getAllByNickname/path-parameters.adoc[]
...
include::{snippets}/article/getAllByFavoritedUserId/path-parameters.adoc[]
...
include::{snippets}/article/putByArticleId/response-fields.adoc[]
