...
[[boardBookmark]]
== 즐겨찾기 게시판 (BoardBookmark)

즐겨찾기 게시판과 관련된 API 정리
...
include::{snippets}/boardBookmark/modify/http-request.adoc[]

===== [request-headers]

include::{snippets}/boardBookmark/modify/request-headers.adoc[]

===== [response-body]

include::{snippets}/boardBookmark/modify/request-fields.adoc[]

==== Response

===== [http-response]

include::{snippets}/boardBookmark/modify/http-response.adoc[]
